    ...
    internal class XNARenderer : INvgRenderer
    {
        ...
        public void Draw(Vector2 viewportSize, float devicePixelRatio, IEnumerable<CallInfo> calls, Vertex[] vertexes)
        {
            try
            {
                ...
                Matrix transform = Matrix.CreateOrthographicOffCenter(0, viewportSize.X, viewportSize.Y, 0, 0, -1);
        ...
        private void DrawVertexes(RenderingType renderingType, PrimitiveType primitiveType, int vertexOffset, int vertexCount, bool indexed)
        {
            ...
            EffectTechnique technique = _techniques[(int)renderingType];
        ...
        private void RenderConvexFill(CallInfo call)
        {
            ...
            RenderingType renderingType = call.UniformInfo.Image != null ? RenderingType.FillImage : RenderingType.FillGradient;
            for (int i = 0; i < call.FillStrokeInfos.Count; i++)
            {
                FillStrokeInfo fillStrokeInfo = call.FillStrokeInfos[i];
        ...
        private void RenderFill(CallInfo call)
        {
            ...
            RenderingType renderingType = RenderingType.Simple;
